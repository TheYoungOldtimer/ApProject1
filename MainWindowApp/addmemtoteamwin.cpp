...
addmemToteamwin::addmemToteamwin(QWidget *parent, QString teamname) :
    QDialog(parent),
...
bool addmemToteamwin::findmember(QString email){
...
void addmemToteamwin::deletemember(QString email){
    QString path = "member.json";
    QJsonDocument doc;
    QJsonDocument jsonOrg;
        QFile file(path); // json file
...
void addmemToteamwin::readdmember(QJsonObject obj){
...
void addmemToteamwin::on_lineEdit_textEdited(const QString &arg1)
{
    mememail = arg1;
...
void addmemToteamwin::on_pushButton_clicked()
{
    deletemember(mememail);
    memedited.insert("myteam",team);
